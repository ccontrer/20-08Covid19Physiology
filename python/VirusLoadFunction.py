...
class VirusLoadFunction:
    ...
    def VirusLoad(self, t, a1, a2, b1, b2, alpha, minv, maxv):
        ...
        return v1(t, a1, a2, maxv)*v2(t, a2, alpha)*v3(t, b1, b2, minv)
    ...
    def Fit(self, **kwargs):
        ...
        minv, maxv = max(np.min(self.vdata),1e-10), np.max(self.vdata)
        minb = 0.
        maxb = [maxt, maxt, maxt, maxt, 1.0, minv, maxv]
        selqf.par, self.pcov = curve_fit(self.VirusLoad, self.tdata, self.vdata,
